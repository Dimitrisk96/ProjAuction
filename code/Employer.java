...
public class Employer {
    ...
    void register(String onoma, String eponimo, String username, String email, String password1,String password2, int phone_number, Date imer, String decription, int balance)
